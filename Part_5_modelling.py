...
# Image Path
stock_img_path = 'C:/Users/malco/Desktop/NN Data, Results/Fixed Window Period Image/Server Data 1 ALL MONTHS 6. NDX Fut 5min 2020 junALL GREEN/Window = ALL_ 40,000 (10,000 x 4)'  # actual
# CSV Path (DO NOT DELETE)
df_main = pd.read_csv('C:/Users/malco/PycharmProjects/7. Keras 1/2020 junALL GREEN ONLY_cols.csv')
