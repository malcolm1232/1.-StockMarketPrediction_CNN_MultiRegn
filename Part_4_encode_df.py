...
def get_label_encoded_cols(file_path_to_df):
    ...
    #Label Encoding is a definite Must.
...
file_path_to_df = 'C:/Users/malco/Desktop/Combined Data/Nasdaq 1min/2020 aprALL GREEN.csv'
